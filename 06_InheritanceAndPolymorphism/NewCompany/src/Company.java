...
public class Company {
    ...
    public static Comparator<Employee> comparatorMax = (s1, s2) -> (int) s1.getMonthSalary() - (int) s2.getMonthSalary();

    public static Comparator<Employee> comparatorMin = (s1, s2) -> (int) s2.getMonthSalary() - (int) s1.getMonthSalary();
